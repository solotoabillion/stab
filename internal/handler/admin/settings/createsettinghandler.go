...
func PostCreateSettingHandler(svcCtx *svc.ServiceContext, path string) echo.HandlerFunc {
	return func(c echo.Context) error {
		var req types.Setting
		...
		l := logicHandler.NewCreateSettingLogic(c.Request().Context(), svcCtx)
		resp, err := l.PostCreateSetting(c, &req)
		if err != nil {
			c.Logger().Error(err)
			return c.JSON(http.StatusInternalServerError, map[string]interface{}{
				"error": "Internal Server Error",
