...
func GetSettingHandler(svcCtx *svc.ServiceContext, path string) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		l := logicHandler.NewGetSettingLogic(c.Request().Context(), svcCtx)
		resp, err := l.GetSetting(c, &req)
		if err != nil {
			c.Logger().Error(err)
			return c.JSON(http.StatusInternalServerError, map[string]interface{}{
				"error": "Internal Server Error",
